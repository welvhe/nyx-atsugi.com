      ...
      <ul class="main-nav__list--<?php echo $main_nav_thematype; ?> main_nav_border_color" itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement">
        ...
        <?php if ($shop['event_privacy'] == 1) : ?>
          <li class="main-nav__list-item--<?php echo $main_nav_thematype; ?> main_nav_border_color main_nav_text_underline_color <?php wp_reset_query();
            ...
            <a itemprop="url" href="<?= site_url('calendar'); ?>/">
              <h2 class="main-nav__list-title-en--<?php echo $main_nav_thematype; ?> main_nav_text_color main_nav_english_font">CALENDAR</h2>
        ...
        <?php if ($casts_count['count(id)'] > 0) : ?>
          <li class="main-nav__list-item--<?php echo $main_nav_thematype; ?> main_nav_border_color main_nav_text_underline_color <?php wp_reset_query();
            ...
            <a itemprop="url" href="<?= site_url('cast'); ?>/">
              <h2 class="main-nav__list-title-en--<?php echo $main_nav_thematype; ?> main_nav_text_color main_nav_english_font">CAST</h2>
              <h3 class="main-nav__list-title-jp--<?php echo $main_nav_thematype; ?> main_nav_text_color">キャスト一覧</h3>
              <svg xmlns="https://www.w3.org/2000/svg" width="13.193" height="21.842" viewBox="0 0 13.193 21.842">
                <defs></defs>
                <path class="a" d="M.987,0,0,.883,11.22,10.921,0,20.959l.987.883L13.193,10.921Z" transform="translate(0 0)" />
              </svg>
        ...
        <?php if ($course_menu_page_exsitance_flg) : ?>
          <li class="main-nav__list-item--<?php echo $main_nav_thematype; ?> main_nav_border_color main_nav_text_underline_color <?php wp_reset_query();
                                                                                                                                  if (is_page('course-menu')) {
                                                                                                                                    echo "main_nav_active";
                                                                                                                                  } ?>" itemprop="name">
            <a itemprop="url" href="<?= site_url('course-menu'); ?>/">
              <h2 class="main-nav__list-title-en--<?php echo $main_nav_thematype; ?> main_nav_text_color main_nav_english_font">COURSE MENU</h2>
              <h3 class="main-nav__list-title-jp--<?php echo $main_nav_thematype; ?> main_nav_text_color">コースメニュー</h3>
              <svg xmlns="https://www.w3.org/2000/svg" width="13.193" height="21.842" viewBox="0 0 13.193 21.842">
                <defs></defs>
                <path class="a" d="M.987,0,0,.883,11.22,10.921,0,20.959l.987.883L13.193,10.921Z" transform="translate(0 0)" />
              </svg>
        ...
        <?php if ($shop['cast_recruit_privacy'] == 1) : ?>
          <li class="main-nav__list-item--<?php echo $main_nav_thematype; ?> main_nav_border_color main_nav_text_underline_color <?php wp_reset_query();
                                                                                                                                  if (is_page('cast-recruit')) {
                                                                                                                                    echo "main_nav_active";
                                                                                                                                  } ?>" itemprop="name">
            <a itemprop="url" href="<?= site_url('cast-recruit'); ?>/">
              <h2 class="main-nav__list-title-en--<?php echo $main_nav_thematype; ?> main_nav_text_color main_nav_english_font">CAST RECRUIT</h2>
              <h3 class="main-nav__list-title-jp--<?php echo $main_nav_thematype; ?> main_nav_text_color">キャスト求人情報</h3>
              <svg xmlns="https://www.w3.org/2000/svg" width="13.193" height="21.842" viewBox="0 0 13.193 21.842">
                <defs></defs>
                <path class="a" d="M.987,0,0,.883,11.22,10.921,0,20.959l.987.883L13.193,10.921Z" transform="translate(0 0)" />
              </svg>
        ...
        <?php if ($shop['staff_recruit_privacy'] == 1) : ?>
          <li class="main-nav__list-item--<?php echo $main_nav_thematype; ?> main_nav_border_color main_nav_text_underline_color <?php wp_reset_query();
            ...
            <a itemprop="url" href="<?php echo $staff_recruit_url; ?>/">
              <h2 class="main-nav__list-title-en--<?php echo $main_nav_thematype; ?> main_nav_text_color main_nav_english_font">STAFF RECRUIT</h2>
              <h3 class="main-nav__list-title-jp--<?php echo $main_nav_thematype; ?> main_nav_text_color">スタッフ求人情報</h3>
              <svg xmlns="https://www.w3.org/2000/svg" width="13.193" height="21.842" viewBox="0 0 13.193 21.842">
                <defs></defs>
                <path class="a" d="M.987,0,0,.883,11.22,10.921,0,20.959l.987.883L13.193,10.921Z" transform="translate(0 0)" />
              </svg>

...
?>
	...
	<section class="cont00 set <?php echo $img_order ?>" <?php echo $section_bg_color; ?>>
		...
		<?php if($fields['メインタイトル']) { ?>
			<h2 class="main_title <?php echo $main_title_class ?> <?php echo $main_title_element ?> <?php echo $cast_recruit_main_title_size;?>" style="color: <?php echo $main_title_font_color; ?>"><?php echo nl2br($fields['メインタイトル']); ?></h2>
		<?php } ?>

		<?php if($fields['サブタイトル']) { ?>
			<h3 class="sub_title text_decoration <?php echo $text_decoration; ?> <?php echo $sub_title_class ?> <?php echo $sub_title_element ?> <?php echo $cast_recruit_sub_title_size;?>" style="color: <?php echo $sub_title_font_color; ?>; border-color:<?php echo $text_decoration_color; ?>"><?php echo nl2br($fields['サブタイトル']); ?></h3>
		<?php } ?>
		...
		<?php if($fields['テキスト']) { ?>
			<div class="text_decoration <?php echo $text_decoration; ?>" style ="border-color:<?php echo $text_decoration_color; ?>; background-color:<?php echo $text_bg_color ?>">
				<p class="text <?php echo $text_class ?> text_element <?php echo $text_element ?> text-size <?php echo $cast_recruit_text_size;?>" style="color: <?php echo $text_font_color; ?>"><?php echo nl2br($fields['テキスト']); ?></p>
		</div>
		<?php } ?>
</section>

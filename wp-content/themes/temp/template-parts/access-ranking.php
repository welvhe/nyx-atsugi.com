...
<?php
    ...
    $weekly_access_ranking_sql = "
        ...
        FROM 
            access
        JOIN 
            casts ON access.cast_id = casts.id
        LEFT JOIN 
            cast_images ON casts.id = cast_images.cast_id AND cast_images.subject_id = 1
        JOIN 
    ...
    <section class="ranking">
        <div class="ranking__inner">
            ...
            <?php if($before_btn == "view") { ?>
                ...
                <?php } else { ?>
                    <a id="ar-after-btn" class="ranking__arcives-link--<?php echo $button_shape_thema_type; ?> button_style border_color" href="<?= site_url('cast'); ?>/"><span>staff page</span></a>
                <?php } ?>
            <?php } else { ?>
